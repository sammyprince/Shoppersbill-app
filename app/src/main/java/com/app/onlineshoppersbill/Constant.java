...
public class Constant {
    ...
    public static final String BASE_URL = "https://pos.shoppersbill.com/api/";
    ...
    public static final String SHARED_PREF_NAME = "com.app.onlineshoppersbill"; //pcakage name+ id
