...
public class EditProductActivity extends BaseActivity {
        ...
        txtUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (productName.isEmpty()) {
                    ...
                    updateProduct(productName, productCode, selectedCategoryID, productDescription, productSellPrice,  productWeight,selectedWeightUnitID,selectedSupplierID,productStock);
            ...
            public void onResponse(@NonNull Call<Product> call, @NonNull Response<Product> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (productData == null) {
                        ...
                        String productCode = productData.getProduct_code();
                        String productCategoryName = productData.getProductCategoryName();
                        String productDescription = productData.getProductDescription();

                        String productStock = productData.getProductStock();
                        String productSellPrice = productData.getProductSellPrice();
                        String productSupplierName= productData.getProductSupplierName();
                        String productImage = productData.getProductImage();

                        String productWeight = productData.getProductWeight();
                        String productWeightUnit = productData.getProductWeightUnit();

                        selectedCategoryID=productData.getProductCategoryId();
                        selectedSupplierID=productData.getProductSupplierID();
                        Log.d("supplier_id",""+selectedSupplierID);
                        selectedWeightUnitID=productData.getProductWeightUnitId();
    ...
    private void  updateProduct(String productName,String productCode,String productCategoryId,String productDescription, String productSellPrice, String productWeight,String productWeightUnitId,String productSupplierId,String productStock) {
